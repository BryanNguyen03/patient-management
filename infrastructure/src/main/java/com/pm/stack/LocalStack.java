...
public class LocalStack extends Stack {
    ...
    // boiler plate code to make new stack
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        // Create ECS services for all microservices
        FargateService authService = createFargateService("AuthService", "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "ZGVlcmVuZHNldmVyYWxkaXNjdXNzYWN0dWFsZGlmZmVycnVzaHR1bmV3aXJlcGFzc2E="));

        authService.getNode().addDependency(authDbHealthCheck);
        authService.getNode().addDependency(authServiceDb);

        FargateService billingService = createFargateService("BillingService", "billing-service",
                List.of(4001, 9001), // app and gRPC ports
                null,
                null); // No DB dependency or additional env vars for billing service
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder.create(this, id)
                ...
                .databaseName(dbName)
                .removalPolicy(RemovalPolicy.DESTROY) // destroy data on stack deletion
                .build();
    }
    ...
    private FargateService createFargateService(String id,
        ...
        // Add to our ECS task definition and return
    ...
    public static void main(final String[] args) {
        ...
        // use bootstrapless synthesizer to skip CDK bootstrap
